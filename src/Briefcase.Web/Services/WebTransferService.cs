...
public class WebTransferService(IHttpClientFactory httpClientFactory) : ITransferService
{
    private HttpClient CreateAuthClient() => httpClientFactory.CreateClient("ApiClient");
    private HttpClient CreateAnonymousClient() => httpClientFactory.CreateClient("AuthClient");
    ...
    public async Task<string> CreateSessionAsync()
    {
        ...
        return result?.Code ?? throw new InvalidOperationException("No session code returned.");
    }
    ...
    private record SessionResponse(string Code);
