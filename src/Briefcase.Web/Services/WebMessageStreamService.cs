...
/// <summary>
/// Browser (WASM) implementation of <see cref="IMessageStreamService"/>. Maintains a single
/// authenticated SignalR connection to <c>/hubs/messages</c> and re-raises the server's
/// message events so open pages can update live.
/// </summary>
public class WebMessageStreamService(IHttpClientFactory httpClientFactory, ITokenStorageService tokenStorage)
